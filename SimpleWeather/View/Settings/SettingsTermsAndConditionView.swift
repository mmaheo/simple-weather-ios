//
//  SettingsTermsAndConditionView.swift
//  SimpleWeather
//
...
struct SettingsTermsAndConditionView: View {
...
struct SettingsTermsAndConditionView_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            SettingsTermsAndConditionView()
